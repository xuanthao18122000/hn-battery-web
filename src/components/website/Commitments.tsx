...
export const Commitments = () => {
  return (
    <section className="mb-4 space-y-4">
      <div className="rounded-2xl bg-gradient-to-r from-sky-500 to-blue-700 px-4 py-7 text-center text-white shadow-lg sm:px-8 md:px-12 md:py-10">
      ...
      <div className="flex flex-col gap-3 rounded border border-gray-200 bg-white p-2.5 text-gray-800 shadow-sm sm:p-4 md:flex-row md:items-center md:justify-between md:gap-6 md:p-6">
